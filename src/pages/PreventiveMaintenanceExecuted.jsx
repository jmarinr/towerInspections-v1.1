...
export default function PreventiveMaintenanceExecuted() {
  ...
  if (isFormCompleted(FORM_ID)) return <FormLockedScreen title="2 Preventive Maintenance Executed" />
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="px-4 py-4 max-w-2xl mx-auto space-y-4">
        <div className="flex items-center justify-between gap-2">
          <div className="flex-1 min-w-0"><FormMetaBar meta={formMeta?.['mantenimiento-ejecutado']} formCode="mantenimiento-ejecutado" formRoute="/intro/mantenimiento-ejecutado" /></div>
          <button
      ...
      <ConfirmFinalizeModal
        show={showConfirm}
        formName="2 Preventive Maintenance Executed"
