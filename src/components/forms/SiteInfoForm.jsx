    ...
    <div className="bg-white rounded-2xl p-4 border border-gray-200">
      ...
      <div className="mb-5">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <input type="text" readOnly placeholder="Latitud, Longitud" value={data.coordenadas} className="flex-1 px-4 py-3 text-[15px] border-2 border-gray-200 rounded-xl bg-gray-50 min-w-0" />
          <button type="button" onClick={handleGetLocation} className="w-full sm:w-auto px-4 py-3 border-2 border-gray-200 rounded-xl bg-white text-gray-600 font-semibold text-sm flex items-center justify-center gap-2 active:scale-95 whitespace-nowrap"><MapPin size={18} />Capturar GPS</button>
        </div>
      </div>
