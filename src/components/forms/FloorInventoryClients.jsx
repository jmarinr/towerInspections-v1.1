      ...
      {clientes.map((c, idx) => (
        <div key={idx} className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          ...
          <div className="p-4">
            ...
            <Input label="Placa de equipos" description="Campo presente en el formato XLSX (texto libre)." placeholder="Ej: placa/identificadores" value={c.placaEquipos || ''} onChange={(e) => updateFloorClientField(idx, 'placaEquipos', e.target.value)} />
