    ...
    <div className={`mb-4 ${className}`}>
      {label && (
        <label className="block mb-2">
          <span className="text-sm font-semibold text-gray-700 flex flex-wrap items-center gap-2">
            {label}
      ...
      <input className={`w-full px-4 py-3 text-[15px] border-2 rounded-xl bg-white transition-all placeholder:text-gray-400 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 ${error ? 'border-red-500' : 'border-gray-200'}`} {...props} />
